      ...
      <div className="relative max-w-5xl mx-auto px-6" ref={ref}>
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            className="absolute left-8 md:left-1/2 top-0 bottom-0 w-[2px] timeline-line origin-top"
          ...
          {experiences.map((exp, i) => (
            <motion.div
              ...
              className="relative flex flex-col md:flex-row gap-8 mb-12 pl-20 md:pl-0"
            >
              {/* Timeline node */}
              <div
                className="absolute left-8 md:left-1/2 top-8 w-4 h-4 rounded-full -translate-x-1/2 z-10"
                style={{
              ...
              {/* Card */}
              <div className="w-full md:w-[calc(50%-2.5rem)] md:ml-auto">
                <motion.div
                  whileHover={{ y: -4 }}
